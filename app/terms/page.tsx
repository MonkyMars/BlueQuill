        ...
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="space-y-6 text-gray-600">
            <section>
              ...
              <p>
                By accessing and using BlueQuill, you accept and agree to be bound by the terms and provision of this agreement.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                BlueQuill provides an AI-powered document editing and optimization platform. Our services include but are not limited to:
              </p>
            ...
            <section>
              ...
              <p>
                In no event shall BlueQuill be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
              </p>
            </section>
